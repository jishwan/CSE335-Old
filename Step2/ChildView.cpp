...
BEGIN_MESSAGE_MAP(CChildView, CWnd)
	...
	ON_WM_MOUSEMOVE()
	ON_WM_ERASEBKGND()
	ON_COMMAND(ID_ADDFISH_MAGIKARP32774, &CChildView::OnAddfishMagikarp32774)
	ON_COMMAND(ID_ADDFISH_NEMO, &CChildView::OnAddfishNemo)
	ON_COMMAND(ID_DECOR_CASTLE, &CChildView::OnAddDecorCastle)
	ON_COMMAND(ID_FILE_SAVEAS, &CChildView::OnFileSaveas)
	ON_COMMAND(ID_FILE_OPEN32780, &CChildView::OnFileOpen32780)
	ON_WM_TIMER()
END_MESSAGE_MAP()
 ...
 */
void CChildView::OnAddfishMagikarp32774()
{
	auto fish = make_shared<CFishKarp>(&mAquarium);
	fish->SetLocation(InitialX, InitialY);
	mAquarium.Add(fish);
	Invalidate();
}
 ...
 */
void CChildView::OnFileOpen32780()
{
